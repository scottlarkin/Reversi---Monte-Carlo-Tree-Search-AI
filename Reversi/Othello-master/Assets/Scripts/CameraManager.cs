...
public class CameraManager : MonoBehaviour {
    ...
    {
        Camera.main.transform.position = new Vector3((board.Size / 2) + ((board.Size / 2) * board.Offset), (board.Size / 2) + ((board.Size / 2) * board.Offset), -10);
        Camera.main.orthographicSize = (board.Size / 2) + (((board.Size / 2) - 1) * board.Offset);
	}
}
